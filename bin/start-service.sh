...
cp -n $SNAP_APP_PATH/usr/share/grafana/conf/defaults.ini $SNAP_APP_DATA_PATH/etc/grafana/grafana.ini
...
$SNAP_APP_PATH/magic-bin/grafana -config=$SNAP_APP_DATA_PATH/etc/grafana/grafana.ini -homepath=$SNAP_APP_PATH/usr/share/grafana -pidfile=$SNAP_APP_DATA_PATH/var/run/grafana.pid cfg:default.paths.logs=$SNAP_APP_DATA_PATH/var/log/grafana cfg:default.paths.data=$SNAP_APP_DATA_PATH/var/lib/grafana default.auth.ldap.config_file=$SNAP_APP_DATA_PATH/etc/grafana/ldap.toml default.dashboards.json.path=$SNAP_APP_DATA_PATH/var/lib/grafana/dashboards
